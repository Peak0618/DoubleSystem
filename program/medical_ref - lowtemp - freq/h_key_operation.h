...
extern flag_type flg_error_code_mark;   //错误代码已读标记
         ...
         #define   bflg_error_code_alarm_TCP_reverse_mark flg_error_code_mark.bits.bit15  // 16
...
//#define   DISP_FACTORY_SS      7   //热交换器故障屏蔽---双系统无此参数
#define   DISP_FACTORY_AA        7   //极限环温报警-环温过高
#define   DISP_FACTORY_Cd        8   //高温机开机延时--初始上电延时xmin后判压机是否开
#define   DISP_FACTORY_CL3       9  //IC卡注册密码初始化
#define   DISP_FACTORY_CL4       10  //恢复出厂值
#define   DISP_FACTORY_PS2       11  //解锁密码-工厂密码
#define   DISP_FACTORY_bS        12  //电池未连接屏蔽
#define   DISP_FACTORY_LL        13  //密钥使能
#define   DISP_FACTORY_HC        14  //柜口加热开关
#define   DISP_FACTORY_A         15  //查看A系统温度
#define   DISP_FACTORY_B         16  //查看B系统温度
#define   DISP_FACTORY_Pb        17  //系统故障时屏蔽灯的闪烁
#define   DISP_FACTORY_PARM_SUM  18  //工厂参数的总数
