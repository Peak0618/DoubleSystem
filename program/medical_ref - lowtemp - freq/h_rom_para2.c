...
const int16_t EEPROM_init[MAX_PARA_NUMBER + 1][5]=
{
  ...
  //双系统
  {    30, -1000,  1000,      1,      not_dot},   //Pr-40   num_db_debug_P00
  {     2, -1000,  1000,      1,      not_dot},   //Pr-41   num_db_debug_P01
  {    30, -1000,  1000,      1,      not_dot},   //Pr-42   num_db_debug_P02
  {     1, -1000,  1000,      1,      not_dot},   //Pr-43   num_db_debug_P03
  {     5, -1000,  1000,      1,      not_dot},   //Pr-44   num_db_debug_P04
  {    16, -1000,  1000,      1,      not_dot},   //Pr-45   num_db_debug_P05
  {    10, -1000,  1000,      1,      not_dot},   //Pr-46   num_db_debug_P06
  {     5, -1000,  1000,      1,      not_dot},   //Pr-47   num_db_debug_P07
  {   -40, -1000,  1000,      1,      not_dot},   //Pr-48   num_db_debug_P08
  {     2, -1000,  1000,      1,      not_dot},   //Pr-49   num_db_debug_P09
  {    -4, -1000,  1000,      1,      not_dot},   //Pr-50   num_db_debug_P10
  {     5, -1000,  1000,      1,      not_dot},   //Pr-51   num_db_debug_P11
  {     5, -1000,  1000,      1,      not_dot},   //Pr-52   num_db_debug_P12
  {     1, -1000,  1000,      1,      not_dot},   //Pr-53   num_db_debug_P13  
};
//------------------------------------------------------------------------------
#endif
