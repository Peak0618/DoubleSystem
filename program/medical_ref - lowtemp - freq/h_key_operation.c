    ...
    else
    {
        if(bflg_parm_dis_form == 0)    //标示
        {
            ...
            else
            {
                ...
                {
                    gsc_disp_parm_type++;
                    if (gsc_disp_parm_type > DISP_FACTORY_Pb)
                    {
                ...
                else if (guc_key_val == KEY_DOWN)    
                {
                    ...
                    {
                        gsc_disp_parm_type = DISP_FACTORY_Pb;
                    }
                }
            }
        }
            ...
            if(guc_key_val == KEY_SET)
            {
                ...
                if(bflg_parm_save == 1)
                {
                    ...
                    else 
                    {
                        ...
                        /*else if(gsc_disp_parm_type == DISP_FACTORY_SS)//双系统无此参数
                        {
                        ...
                        //else if(gsc_disp_parm_type == DISP_FACTORY_A)  //不保存
                        //{
                        //}
                        //else if(gsc_disp_parm_type == DISP_FACTORY_B)
                        //{
                        //}
                        else if(gsc_disp_parm_type == DISP_FACTORY_Pb)
                        {
                            ram_para[num_db_system_fault_masking] = gss_factory_parm_value[DISP_FACTORY_Pb];                                                                    //!!!!!!!
                            eeprom_write(num_db_system_fault_masking, ram_para[num_db_system_fault_masking]); 
                        }
                    }
                }
            }
            else
            {
                if(guc_key_val == KEY_UP)
                {
                    ...
                    /*else if(gsc_disp_parm_type == DISP_FACTORY_SS) //双系统无此参数
                     ...
                     //else if(gsc_disp_parm_type == DISP_FACTORY_A)
                     //{
                     //}
                     //else if(gsc_disp_parm_type == DISP_FACTORY_B)
                     //{
        ...
        else
        {
            if (bflg_disp1_val == 0)          //如果不显示设定值
            {
                ...
                else
                {
                    ...
                    {
                        gsc_disp1_para_mode++; 
                        if (gsc_disp1_para_mode > DB_P13)  
                        {
                            gsc_disp1_para_mode = DB_P00;
                        }
                    }
                    else if (guc_key_val == KEY_DOWN)
                    {
                        gsc_disp1_para_mode--;
                        if (gsc_disp1_para_mode < DB_P00)
                        {
                            gsc_disp1_para_mode = DB_P13;
                        }
                    }
                }
            }
            else                                 //如果是显示设定值
            {
                ...
                else
                {
                    if (guc_key_val == KEY_UP)
                    { 
                        gss_db_debug_parm_value[gsc_disp1_para_mode] += 1;
                       
                        if(gsc_disp1_para_mode == DB_P00)
                        {
                            if(gss_db_debug_parm_value[gsc_disp1_para_mode] > 50)
                            {
                                gss_db_debug_parm_value[gsc_disp1_para_mode] = 1;
                            }
                            ram_para[num_db_debug_P00] = gss_db_debug_parm_value[gsc_disp1_para_mode];                                                                    //!!!!!!!
                            eeprom_write(num_db_debug_P00, ram_para[num_db_debug_P00]);
                        }
                        else if(gsc_disp1_para_mode == DB_P01)
                        {
                            if(gss_db_debug_parm_value[gsc_disp1_para_mode] > 50)
                            {
                                gss_db_debug_parm_value[gsc_disp1_para_mode] = 1;
                            }
                            ram_para[num_db_debug_P01] = gss_db_debug_parm_value[gsc_disp1_para_mode];                                                                    //!!!!!!!
                            eeprom_write(num_db_debug_P01, ram_para[num_db_debug_P01]);
                        }                        
                        else if(gsc_disp1_para_mode == DB_P02)
                        {
                            if(gss_db_debug_parm_value[gsc_disp1_para_mode] > 50)
                            {
                                gss_db_debug_parm_value[gsc_disp1_para_mode] = 1;
                            }
                            ram_para[num_db_debug_P02] = gss_db_debug_parm_value[gsc_disp1_para_mode];                                                                    //!!!!!!!
                            eeprom_write(num_db_debug_P02, ram_para[num_db_debug_P02]);
                        }  
                        else if(gsc_disp1_para_mode == DB_P03)
                        {
                            if(gss_db_debug_parm_value[gsc_disp1_para_mode] > 10)
                            {
                                gss_db_debug_parm_value[gsc_disp1_para_mode] = 1;
                            }                        
                            ram_para[num_db_debug_P03] = gss_db_debug_parm_value[gsc_disp1_para_mode];                                                                    //!!!!!!!
                            eeprom_write(num_db_debug_P03, ram_para[num_db_debug_P03]);
                        }  
                        else if(gsc_disp1_para_mode == DB_P04)
                        {
                            if(gss_db_debug_parm_value[gsc_disp1_para_mode] > 10)
                            {
                                gss_db_debug_parm_value[gsc_disp1_para_mode] = 1;
                            }                        
                            ram_para[num_db_debug_P04] = gss_db_debug_parm_value[gsc_disp1_para_mode];                                                                    //!!!!!!!
                            eeprom_write(num_db_debug_P04, ram_para[num_db_debug_P04]);
                        }  
                        else if(gsc_disp1_para_mode == DB_P05)
                        {
                            if(gss_db_debug_parm_value[gsc_disp1_para_mode] > 20)
                            {
                                gss_db_debug_parm_value[gsc_disp1_para_mode] = 1;
                            }                        
                            ram_para[num_db_debug_P05] = gss_db_debug_parm_value[gsc_disp1_para_mode];                                                                    //!!!!!!!
                            eeprom_write(num_db_debug_P05, ram_para[num_db_debug_P05]);
                        }  
                        else if(gsc_disp1_para_mode == DB_P06)
                        {
                            if(gss_db_debug_parm_value[gsc_disp1_para_mode] > 20)
                            {
                                gss_db_debug_parm_value[gsc_disp1_para_mode] = 1;
                            }                         
                            ram_para[num_db_debug_P06] = gss_db_debug_parm_value[gsc_disp1_para_mode];                                                                    //!!!!!!!
                            eeprom_write(num_db_debug_P06, ram_para[num_db_debug_P06]);
                        }  
                        else if(gsc_disp1_para_mode == DB_P07)
                        {
                            if(gss_db_debug_parm_value[gsc_disp1_para_mode] > 20)
                            {
                                gss_db_debug_parm_value[gsc_disp1_para_mode] = 1;
                            }                         
                            ram_para[num_db_debug_P07] = gss_db_debug_parm_value[gsc_disp1_para_mode];                                                                    //!!!!!!!
                            eeprom_write(num_db_debug_P07, ram_para[num_db_debug_P07]);
                        }  
                        else if(gsc_disp1_para_mode == DB_P08)
                        {
                            if(gss_db_debug_parm_value[gsc_disp1_para_mode] > -10)
                            {
                                gss_db_debug_parm_value[gsc_disp1_para_mode] = -50;
                            }                         
                            ram_para[num_db_debug_P08] = gss_db_debug_parm_value[gsc_disp1_para_mode];                                                                    //!!!!!!!
                            eeprom_write(num_db_debug_P08, ram_para[num_db_debug_P08]);
                        }  
                        else if(gsc_disp1_para_mode == DB_P09)
                        {
                            if(gss_db_debug_parm_value[gsc_disp1_para_mode] > 10)
                            {
                                gss_db_debug_parm_value[gsc_disp1_para_mode] = 1;
                            }                         
                            ram_para[num_db_debug_P09] = gss_db_debug_parm_value[gsc_disp1_para_mode];                                                                    //!!!!!!!
                            eeprom_write(num_db_debug_P09, ram_para[num_db_debug_P09]);
                        }  
                        else if(gsc_disp1_para_mode == DB_P10)
                        {
                            if(gss_db_debug_parm_value[gsc_disp1_para_mode] > -1)
                            {
                                gss_db_debug_parm_value[gsc_disp1_para_mode] = -10;
                            }                         
                            ram_para[num_db_debug_P10] = gss_db_debug_parm_value[gsc_disp1_para_mode];                                                                    //!!!!!!!
                            eeprom_write(num_db_debug_P10, ram_para[num_db_debug_P10]);
                        }  
                        else if(gsc_disp1_para_mode == DB_P11)
                        {
                            if(gss_db_debug_parm_value[gsc_disp1_para_mode] > 15)
                            {
                                gss_db_debug_parm_value[gsc_disp1_para_mode] = 1;
                            }                         
                            ram_para[num_db_debug_P11] = gss_db_debug_parm_value[gsc_disp1_para_mode];                                                                    //!!!!!!!
                            eeprom_write(num_db_debug_P11, ram_para[num_db_debug_P11]);
                        }  
                        else if(gsc_disp1_para_mode == DB_P12)
                        {
                            if(gss_db_debug_parm_value[gsc_disp1_para_mode] > 15)
                            {
                                gss_db_debug_parm_value[gsc_disp1_para_mode] = 1;
                            }                         
                            ram_para[num_db_debug_P12] = gss_db_debug_parm_value[gsc_disp1_para_mode];                                                                    //!!!!!!!
                            eeprom_write(num_db_debug_P12, ram_para[num_db_debug_P12]);
                        }  
                        else if(gsc_disp1_para_mode == DB_P13)
                        {
                            if(gss_db_debug_parm_value[gsc_disp1_para_mode] > 5)
                            {
                                gss_db_debug_parm_value[gsc_disp1_para_mode] = 1;
                            }                         
                            ram_para[num_db_debug_P13] = gss_db_debug_parm_value[gsc_disp1_para_mode];                                                                    //!!!!!!!
                            eeprom_write(num_db_debug_P13, ram_para[num_db_debug_P13]);
                        }                          
                    }
                    else if (guc_key_val == KEY_DOWN)
                    {  
                        ...
                        else if(gsc_disp1_para_mode == DB_P05)
                        {
                            if(gss_db_debug_parm_value[gsc_disp1_para_mode] < 1)
                            {
                                gss_db_debug_parm_value[gsc_disp1_para_mode] = 20;
                            }                        
                            ram_para[num_db_debug_P05] = gss_db_debug_parm_value[gsc_disp1_para_mode];                                                                    //!!!!!!!
                            eeprom_write(num_db_debug_P05, ram_para[num_db_debug_P05]);
                        }  
                        ...
                        else if(gsc_disp1_para_mode == DB_P11)
                        {
                            if(gss_db_debug_parm_value[gsc_disp1_para_mode] < 1)
                            {
                                gss_db_debug_parm_value[gsc_disp1_para_mode] = 15;
                            }                         
                            ram_para[num_db_debug_P11] = gss_db_debug_parm_value[gsc_disp1_para_mode];                                                                    //!!!!!!!
                            eeprom_write(num_db_debug_P11, ram_para[num_db_debug_P11]);
                        }  
                        ...
                        else if(gsc_disp1_para_mode == DB_P13)
                        {
                            if(gss_db_debug_parm_value[gsc_disp1_para_mode] < 1)
                            {
                                gss_db_debug_parm_value[gsc_disp1_para_mode] = 5;
                            }                         
                            ram_para[num_db_debug_P13] = gss_db_debug_parm_value[gsc_disp1_para_mode];                                                                    //!!!!!!!
                            eeprom_write(num_db_debug_P13, ram_para[num_db_debug_P13]);
                        }                           
...
/*{   
    ...
    else if(gsc_disp_debug_mode == DISP_DEBUG_SEE)
    {
        if (guc_key_val == KEY_BUZ)
        {
            guc_disp_mode = DISP_DEBUG_SELECT;       //回到上一层
