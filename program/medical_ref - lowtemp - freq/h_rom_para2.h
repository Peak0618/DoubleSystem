...
//------------------------------------------------------------------------------
//参数个数定义
#define   MAX_PARA_NUMBER      60       //参数总数
//------------------------------------------------------------------------------
//参数编号定义
...
//双系统调试参数
#define   num_db_debug_P00                        40  
#define   num_db_debug_P01                        41  
#define   num_db_debug_P02                        42  
#define   num_db_debug_P03                        43  
#define   num_db_debug_P04                        44  
#define   num_db_debug_P05                        45 
#define   num_db_debug_P06                        46  
#define   num_db_debug_P07                        47  
#define   num_db_debug_P08                        48 
#define   num_db_debug_P09                        49  
#define   num_db_debug_P10                        50  
#define   num_db_debug_P11                        51 
#define   num_db_debug_P12                        52  
#define   num_db_debug_P13                        53 

#define   num_db_system_fault_masking             54   //Pb
